    ...
    return (
      <div
        className="
          ...
          bg-gradient-to-br from-emerald-100 via-white to-indigo-100
        "
      >
        ...
        >
          <div className="relative flex h-64 w-64 items-center justify-center md:h-72 md:w-72">
            <div
              className="
                absolute inset-0
                rounded-full bg-emerald-300/30
                blur-3xl
                animate-pulse-slow
              "
            />
            <div
              className="
                ...
                overflow-hidden
                shadow-2xl shadow-emerald-100/70
                transition-all duration-500
                hover:scale-105 hover:shadow-emerald-200
                md:h-72 md:w-72
              "
            >
              <img
          ...
          <div className="mt-6 w-full max-w-md space-y-6 text-center md:text-center">
            <p
              className={`
                ...
                font-medium tracking-tight text-slate-700
                transition-all duration-[1300ms] ease-out
                hover:-translate-y-0.5 hover:text-emerald-800
                ${
                  isReadyToShow
                    ? "opacity-100 translate-y-0"
